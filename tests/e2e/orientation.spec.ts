...
test('Chinese and English searches stay in their language index', async ({ page }) => {
  ...
  for (const scenario of [
    ...
    { route: '/', button: /搜索/, query: 'A02 多阶段归约 屏障 运算顺序', localePrefix: '/', expectedHrefs: ['/algorithms/multi-stage-reduction/'] },
    { route: '/', button: /搜索/, query: 'A03 包含式 排除式 扫描', localePrefix: '/', expectedHrefs: ['/algorithms/inclusive-exclusive-scan/'] },
    { route: '/', button: /搜索/, query: 'A04 私有化直方图', localePrefix: '/', expectedHrefs: ['/algorithms/privatized-histogram/'] },
    { route: '/', button: /搜索/, query: 'Q02 浮点顺序 确定性 逐位可复现性', localePrefix: '/', expectedHrefs: ['/correctness/floating-point-order-reproducibility/'] },
    { route: '/', button: /搜索/, query: 'EX11 多阶段归约可运行示例', localePrefix: '/', expectedHrefs: ['/examples/multi-stage-reduction/'] },
    ...
    { route: '/en/', button: /Search/, query: 'A03 Inclusive and Exclusive Scan', localePrefix: '/en/', expectedHrefs: ['/en/algorithms/inclusive-exclusive-scan/'] },
