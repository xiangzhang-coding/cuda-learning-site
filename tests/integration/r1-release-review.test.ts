...
const r1Labs = ['LAB01', 'LAB02', 'LAB03', 'LAB04', 'LAB05', 'LAB07'] as const;
const r1Visuals = [
...
describe('immutable R1 release history', () => {
  it('preserves the exact reviewed R1 contract after later releases', async () => {
    const sourceManifest = await readJson('src/r1-release-manifest.json');
    ...
    expect(sourceManifest.evidence).toEqual({
      ...
      pendingHardwareVerification: [...r1Examples, ...r1Labs],
      runtimeVerified: [],
