...
describe('Learning Unit and Lab metadata', () => {
  it.each([
    ...
    ...['Q06', 'Q07', 'Q08', 'Q09', 'Q10', 'Q11', 'Q12'].flatMap((unitId) => [
      unitId,
      `${unitId}-EXERCISES`,
      `${unitId}-SOLUTIONS`,
    ]),
    ...
    'PB-R0-005', 'PB-R3', 'PB-R3-001', 'PB-R3-002', 'PB-R3-003', 'PB-R3-004', 'PB-R3-005', 'PB-R3-006', 'PB-R3-007', 'PB-R3-008', 'PB-R3-009', 'PB-R3-010',
  ])(
