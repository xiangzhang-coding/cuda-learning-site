...
The current rolling Stable Curriculum publication contains 56 Learning Units: O01-O08, F01-F08, M01-M19, A01-A09/A14, and Q01-Q11. Exercises and reviewed solutions accompany O02-O08, F01-F08, M01-M19, A01-A09/A14, and every Q unit. The public surface also contains sixteen Runnable Examples, EX01-EX16; ten Labs, LAB01-LAB10; eighteen formal Visual Explainers, standalone VIS01-VIS14 plus embedded VIS19-VIS22; 58 Practice Bank entries; 165 Glossary terms; 70 source/version records; and About. These files form exactly 213 bilingual Publication Pairs and 426 source routes. Future Q13, L06, and LAB12 remain unpublished; LAB12 waits for both Q13 and L06.

The issue #27 graph adds [Q11](https://cuda-learning-site.hmzhangxiang.workers.dev/en/correctness/transpose-optimization-case-study/)`<-[A05,Q06,Q08,Q10]` and [LAB10](https://cuda-learning-site.hmzhangxiang.workers.dev/en/labs/optimize-canonical-transpose/)`<-[Q11]`. The validated current catalog contains 10 Labs, 58 Practice Bank entries, 18 Visual Explainers, 165 Glossary terms, and 70 source/version records, or 321 records total.
...
[Issues #19-#26](https://github.com/xiangzhang-coding/cuda-learning-site/issues/19) retain the prior owner-source review. Issue #27 adds `SRC-CUDA-053` and `SRC-CUDA-054` for controlled transpose optimization and LAB10's selected-Lane profiler, workload, custody, and evidence boundaries. Context7 retrieval was used only for discovery and cross-checking; exact owner documents govern, and neither retrieval nor source review creates runtime or performance evidence.
