...
The current rolling Stable Curriculum publication contains 52 Learning Units: O01-O08, F01-F08, M01-M19, A01-A09, and Q01-Q08. Exercises and reviewed solutions accompany O02-O08, F01-F08, M01-M19, A01-A09, and every Q unit. The public surface also contains sixteen Runnable Examples, EX01-EX16; eight Labs, LAB01-LAB08; seventeen formal Visual Explainers, standalone VIS01-VIS12 and VIS14 plus embedded VIS19-VIS22; 53 Practice Bank entries; 159 Glossary terms; 65 source/version records; and About. These files form exactly 198 bilingual Publication Pairs and 396 source routes. Future Q11 and LAB10 have no public destinations, and LAB10 remains unpublished until Q11 is published. Q13, L06, and LAB12 also have no public destinations; LAB12 remains unpublished until Q13 and L06 are published.

The strict graph retains `A08<-[A05,M03,M04,A02]`, `A09<-[A03,A04]`, `EX15<-A08`, and `VIS12<-A08`, then adds `Q06<-[Q05]`, `Q07<-[M07,M09,Q05]`, `Q08<-[Q07,M02,M03]`, `LAB06<-[M09,Q07]`, `LAB08<-[Q07,Q08]`, and `VIS14<-[Q07,Q08]`. The validated current catalog contains 8 Labs, 53 Practice Bank entries, 17 Visual Explainers, 159 Glossary terms, and 65 source/version records, or 302 records total.
...
[Issues #19-#23](https://github.com/xiangzhang-coding/cuda-learning-site/issues/19) reviewed the R2 current and archived CUDA owner documentation plus the immutable CCCL v3.4.2 release, recorded in `SRC-CUDA-025` through `SRC-CUDA-045`. Issue #25 adds `SRC-CUDA-046` through `SRC-CUDA-049`: APOD from CUDA C++ Best Practices Guide v13.3; Nsight Systems 2026.4 with 2026.4.1 release notes and Lane versions 2022.4.2.1/2025.1.3.140/2026.1.3.425; Nsight Compute 2026.2.1 with Lane versions 2022.3.0.22/2025.2.1.3/2026.2.1.5; and CUPTI 2026.2.1 with Lane coordinates 11.8.87/12.9.79/13.3.75. Context7 retrieval was used only for discovery and cross-checking; exact owner documents govern, and neither retrieval nor source review creates runtime or performance evidence.

The build is fully static. All seventeen Visual Explainers use deterministic browser-only models, preserve static or textual fallbacks, execute no CUDA, and grant no CUDA Evidence Status. VIS12's hierarchy panels are not emitted-instruction, runtime, or performance observations. VIS14 launches neither `nsys` nor `ncu`, parses no profiler report, and publishes no timeline, metric, bottleneck, or speedup result. Theme selection is the only learner preference retained across browser sessions.
