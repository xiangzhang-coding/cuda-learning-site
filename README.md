...
The current rolling Stable Curriculum publication contains 60 Learning Units: O01-O08, F01-F08, M01-M19, A01-A11/A14, and Q01-Q13. Exercises and reviewed solutions accompany O02-O08, F01-F08, M01-M19, A01-A11/A14, and every Q unit. The public surface also contains sixteen Runnable Examples, EX01-EX16; ten Labs, LAB01-LAB10; nineteen formal Visual Explainers, standalone VIS01-VIS14/VIS18 plus embedded VIS19-VIS22; 64 Practice Bank entries; 170 Glossary terms; 74 source/version records; and About. These files form exactly 226 bilingual Publication Pairs and 452 source routes.

The issue #30 graph adds [A10](https://cuda-learning-site.hmzhangxiang.workers.dev/en/algorithms/numerically-stable-softmax/)`<-[A02,M02,M03]`, [A11](https://cuda-learning-site.hmzhangxiang.workers.dev/en/algorithms/attention-as-an-io-problem/)`<-[A08,A10]`, and [VIS18](https://cuda-learning-site.hmzhangxiang.workers.dev/en/visuals/attention-memory-traffic/)`<-[A11]`. The validated current catalog contains 10 Labs, 64 Practice Bank entries, 19 Visual Explainers, 170 Glossary terms, and 74 source/version records, or 337 records total.
...
[Issues #19-#29](https://github.com/xiangzhang-coding/cuda-learning-site/issues/19) retain the prior owner-source review. Issue #30 adds `SRC-CUDA-057/058` for stable/online softmax, scaled attention, exact tiled recurrence, and logical IO boundaries. Context7 retrieval was used only for discovery and cross-checking; exact owner documents and original papers govern, and neither retrieval nor source review creates runtime or performance evidence.
