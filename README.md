...
The published Stable Curriculum contains the complete O01-O08 orientation, F01-F08 foundation track, and M01-M04 memory track, with paired Exercises and reviewed solutions for O02-O08 and every F01-F08 and M01-M04 Learning Unit. The current bilingual source baseline also contains Home; the canonical EX01 environment-report, EX02 vector-addition, EX03 multidimensional-indexing, EX04 error-handling-lifecycle, EX05 coalesced-and-strided-access, and EX06 shared-memory-tile-bank-padding Runnable Examples; LAB01-LAB03; nine formal Visual Explainers, comprising the standalone VIS01 Kernel Journey, VIS02 Indexing, VIS04 Memory-request Segment Grouping, VIS05 Shared-memory Bank Mapping, and VIS06 Memory Hierarchy, Ownership, and Lifetime pages plus embedded VIS19 Error-Surfacing Timeline, VIS20 Compute-Capability Contract Filter, VIS21 Runtime/Driver API Boundary, and VIS22 Block-Shape Constraint Explorer; 21 Practice Bank entries; 76 Glossary terms; 34 source/version records; and About. Complete bilingual indexes provide direct lookup while preserving prerequisite links. Silicon Light, Profiler Dark, and Blueprint style this same content without changing its structure or meaning. Navigation exposes no unfinished Learning Unit.

The added strict prerequisite edges are `F05<-F04`, `F06<-[F02,O03]`, `F07<-[F04,F05]`, `F08<-[F02,F03,F06]`, `M01<-[F04,F06]`, `M02<-[M01,F03]`, `M03<-[M01,M02]`, `M04<-M03`, `EX04<-F05`, `EX05<-M02`, `EX06<-[M03,M04]`, and `LAB03<-[F03,F05]`. F08 is related to LAB03 but is not a LAB03 prerequisite. The validated catalog summary is 3 Labs, 21 Practice Bank entries, 9 Visual Explainers, 76 Glossary terms, and 34 source/version records, or 143 entries total.
