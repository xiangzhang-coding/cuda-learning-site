...
The rolling R4 surface adds [L01](https://cuda-learning-site.hmzhangxiang.workers.dev/en/libraries/library-primitive-dsl-custom-kernel/)`<-[A02,A03,A08,Q06]` and [L02](https://cuda-learning-site.hmzhangxiang.workers.dev/en/libraries/thrust-algorithm-vocabulary/)`<-[A01,A03,A09]` through issue #33. Current scope is 64 Learning Units, 63 Exercise sets, 63 separate reviewed-solution sets, 238 Publication Pairs, and 476 source routes. The validated current catalog contains 10 Labs, 68 Practice Bank entries, 19 Visual Explainers, 182 Glossary terms, and 78 source/version records, or 357 records total.
