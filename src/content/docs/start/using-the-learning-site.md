...
15. 可运行示例集合是 EX01-EX18，最新项目为 [EX18：cuBLAS GEMM](/examples/cublas-gemm/)`<-[L06]`；实验集合是 LAB01-LAB12，最新活动为 [LAB12：对比教学 GEMM 与 cuBLAS](/labs/compare-gemm-with-cublas/)`<-[Q13,L06]`。可视化路线保留 [VIS18：Attention Memory Traffic](/visuals/attention-memory-traffic/)`<-[A11]`；L08-L13 与 EX20 仍待发布。
...
完成这些基础后，算法路线从 A02/M02/M03 汇入 A10，再由 A08/A10 汇入 A11；M01/M02 汇入 A12，A12/A08 再汇入 A13；A14 继续由 A01/A02/A05/A08 汇入。A02/A03/A08/Q06 汇入 L01，A01/A03/A09 汇入 L02，A02/A03/M07/L01 汇入 L03，F02/M03/M05/A02/A03/L03 汇入 L04，M05/M13/M19 汇入 L05，A08/Q01 汇入 L06，L06/Q05 汇入 L07。Q12/L03 汇入 LAB11，EX17 提供其规范 CUB 实现；Q13/L06 汇入 LAB12，由 EX15 与 EX18 提供对比实现。VIS18 严格依赖 A11。L08-L13 与 EX20 不进入当前图。
