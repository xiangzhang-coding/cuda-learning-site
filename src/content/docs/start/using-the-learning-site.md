...
14. 当前十五个 Runnable Example 严格是 EX01-EX14 与 EX16。[EX14 分块矩阵转置](/examples/tiled-transpose/)仅依赖 A05；EX15 不存在公开目标。六个非连续 Lab 严格是 LAB01-LAB05 与 LAB07；LAB06、Q11 与 LAB10 均未发布，LAB10 等待 Q11 的 evidence-based optimization prerequisite。F08 与 LAB03 相关，但不是 LAB03 的先修条件。
