...
Inspect the separate [reviewed solutions](/en/toolchain/compiler-architecture-targets/solutions/) and then audit [Practice Bank PB-R2-009](/en/practice/#pb-r2-009). Use [TERM-060](/en/glossary/#term-060) through [TERM-063](/en/glossary/#term-063) for target and scope labels, and [TERM-118](/en/glossary/#term-118) through [TERM-121](/en/glossary/#term-121) for PTX, cubin, fatbinary, and SASS. When comparing [VIS09](/en/visuals/artifact-pipeline/) with related [EX10](/en/examples/ptx-fatbinary-inspection/), keep a placeholder, a plan, and an observed artifact distinct.
