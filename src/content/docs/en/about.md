...
As of **2026-09-13**, the current publication has 85 Learning Units, 22 Runnable Examples (EX01-EX22), 13 Labs (LAB01-LAB13), 19 Visual Explainers, 92 [Practice Bank](/en/practice/) entries, 204 [Glossary](/en/glossary/) terms and 101 [source records](/en/sources-and-versions/): 429 catalog records, 310 Publication Pairs and 620 source routes, including 84 Exercise sets and 84 separate reviewed-solution sets.
...
The current 92-entry Practice Bank includes PB-R5-001 through PB-R5-010. R4's eight library-and-algorithm-choice entries and R3's ten Nsight report-analysis entries remain unchanged. Only EX02, EX10 and LAB02 are Compile-Checked; EX10 is Runtime-Not-Applicable. The other 21 examples and all 13 Labs remain Pending Hardware Verification, 34 subjects total. P01-P10 keep four empty evidence arrays. EX21 and EX22 have empty compilation/recorded observations; host checks grant no GPU evidence. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts remain zero. All six profiler plans are expected-only.
