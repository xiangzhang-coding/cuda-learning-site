...
As of **2026-09-20**, the current publication has 102 Learning Units, 24 Runnable Examples (EX01-EX24), 18 Labs (LAB01-LAB18), 21 Visual Explainers, 111 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 115 [source records](/en/sources-and-versions/): 472 catalog records, 370 Publication Pairs and 740 source routes, including 101 Exercise sets and 101 separate reviewed-solution sets. [G07](/en/multi-gpu/pytorch-ddp-nccl/) adds DDP ownership, gradients and bounded diagnosis. There are 41 subjects Pending Hardware Verification; G07's external scenarios are also unobserved. R5's frozen review is unchanged and R6 is pending.
...
The current 111-entry Practice Bank includes PB-R5-001 through PB-R5-020 and PB-R6-001 through PB-R6-009. R4's eight library-and-algorithm-choice entries and R3's ten Nsight report-analysis entries remain unchanged. Only EX02, EX10 and LAB02 are Compile-Checked; EX10 is Runtime-Not-Applicable. The other 23 examples and all 18 Labs remain Pending Hardware Verification, 41 subjects total. P01-P12, T01-T08 and G01-G07 keep four empty evidence arrays. EX21-EX24 have empty compilation/recorded observations; host checks grant no GPU evidence. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts remain zero. All six profiler plans are expected-only; LAB18's timeline and G07's diagnostic fixtures are synthetic.
