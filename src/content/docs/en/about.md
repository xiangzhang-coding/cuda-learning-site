...
As of **2026-09-15**, the current publication has 94 Learning Units, 23 Runnable Examples (EX01-EX23), 16 Labs (LAB01-LAB16), 20 Visual Explainers, 102 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 107 [source records](/en/sources-and-versions/): 452 catalog records, 342 Publication Pairs and 684 source routes, including 93 Exercise sets and 93 separate reviewed-solution sets. [T06](/en/triton/debugging/) and [T07](/en/triton/persistent-kernels/) extend the Triton path with debugging and persistent scheduling; [LAB16](/en/labs/autotune-triton-gemm/) supplies the nonpersistent baseline.
