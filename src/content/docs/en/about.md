...
As of **2026-09-14**, the current publication has 90 Learning Units, 23 Runnable Examples (EX01-EX23), 15 Labs (LAB01-LAB15), 20 Visual Explainers, 98 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 104 [source records](/en/sources-and-versions/): 444 catalog records, 329 Publication Pairs and 658 source routes, including 89 Exercise sets and 89 separate reviewed-solution sets. [T01](/en/triton/programs-and-block-values/) and [T02](/en/triton/masked-vector-addition/) provide the Triton mental model and vector addition with [EX23](/en/examples/triton-vector-add/) and [VIS17](/en/visuals/simt-triton-mapping/); [T03](/en/triton/fused-softmax/) and [LAB15](/en/labs/verify-fused-softmax/) add fused softmax.
...
The current 98-entry Practice Bank includes PB-R5-001 through PB-R5-016. R4's eight library-and-algorithm-choice entries and R3's ten Nsight report-analysis entries remain unchanged. Only EX02, EX10 and LAB02 are Compile-Checked; EX10 is Runtime-Not-Applicable. The other 22 examples and all 15 Labs remain Pending Hardware Verification, 37 subjects total. P01-P12 and T01-T03 keep four empty evidence arrays. EX21-EX23 have empty compilation/recorded observations; host checks grant no GPU evidence. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts remain zero. All six profiler plans are expected-only.
