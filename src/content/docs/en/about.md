...
As of **2026-09-19**, the current publication has 100 Learning Units, 24 Runnable Examples (EX01-EX24), 17 Labs (LAB01-LAB17), 21 Visual Explainers, 107 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 113 [source records](/en/sources-and-versions/): 465 catalog records, 363 Publication Pairs and 726 source routes, including 99 Exercise sets and 99 separate reviewed-solution sets. [G04](/en/multi-gpu/nccl-communicators-collectives/) and [G05](/en/multi-gpu/nccl-stream-dependencies/) extend G01-G03 into NCCL communication. Two-GPU observations remain Pending Hardware Verification; R5's frozen review is unchanged and R6 is pending.
...
The current 107-entry Practice Bank includes PB-R5-001 through PB-R5-020 and PB-R6-001 through PB-R6-005. R4's eight library-and-algorithm-choice entries and R3's ten Nsight report-analysis entries remain unchanged. Only EX02, EX10 and LAB02 are Compile-Checked; EX10 is Runtime-Not-Applicable. The other 23 examples and all 17 Labs remain Pending Hardware Verification, 40 subjects total. P01-P12, T01-T08 and G01-G05 keep four empty evidence arrays. EX21-EX24 have empty compilation/recorded observations; host checks grant no GPU evidence. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts remain zero. All six profiler plans are expected-only.
