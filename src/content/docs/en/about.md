...
As of **2026-09-20**, the current publication has 101 Learning Units, 24 Runnable Examples (EX01-EX24), 18 Labs (LAB01-LAB18), 21 Visual Explainers, 109 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 114 [source records](/en/sources-and-versions/): 469 catalog records, 367 Publication Pairs and 734 source routes, including 100 Exercise sets and 100 separate reviewed-solution sets. [G06](/en/multi-gpu/communication-computation-overlap/) adds communication/computation pipeline reasoning. There are 41 subjects Pending Hardware Verification; R5's frozen review is unchanged and R6 is pending.
...
The current 109-entry Practice Bank includes PB-R5-001 through PB-R5-020 and PB-R6-001 through PB-R6-007. R4's eight library-and-algorithm-choice entries and R3's ten Nsight report-analysis entries remain unchanged. Only EX02, EX10 and LAB02 are Compile-Checked; EX10 is Runtime-Not-Applicable. The other 23 examples and all 18 Labs remain Pending Hardware Verification, 41 subjects total. P01-P12, T01-T08 and G01-G06 keep four empty evidence arrays. EX21-EX24 have empty compilation/recorded observations; host checks grant no GPU evidence. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts remain zero. All six profiler plans are expected-only; LAB18's timeline fixture is synthetic.
