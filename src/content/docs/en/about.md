...
As of **2026-09-14**, the current publication has 92 Learning Units, 23 Runnable Examples (EX01-EX23), 16 Labs (LAB01-LAB16), 20 Visual Explainers, 100 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 105 [source records](/en/sources-and-versions/): 448 catalog records, 336 Publication Pairs and 672 source routes, including 91 Exercise sets and 91 separate reviewed-solution sets. [T04](/en/triton/blocked-matrix-multiplication/) and [T05](/en/triton/autotuning/) extend the earlier Triton mental-model/vector-add/softmax path with blocked GEMM and [LAB16](/en/labs/autotune-triton-gemm/).
...
The current 100-entry Practice Bank includes PB-R5-001 through PB-R5-018. R4's eight library-and-algorithm-choice entries and R3's ten Nsight report-analysis entries remain unchanged. Only EX02, EX10 and LAB02 are Compile-Checked; EX10 is Runtime-Not-Applicable. The other 22 examples and all 16 Labs remain Pending Hardware Verification, 38 subjects total. P01-P12 and T01-T05 keep four empty evidence arrays. EX21-EX23 have empty compilation/recorded observations; host checks grant no GPU evidence. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts remain zero. All six profiler plans are expected-only.
