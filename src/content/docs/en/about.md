...
**Publication inventory and navigation updated: 2026-09-09.** The page date covers only this inventory update, not a new review of existing CUDA API facts; technical sources retain their individual access and review dates.
...
For factual, bilingual-alignment, link, accessibility, or source problems, open a reproducible report in [GitHub Issues](https://github.com/xiangzhang-coding/cuda-learning-site/issues). The page's publication inventory was checked on **2026-09-09**.
