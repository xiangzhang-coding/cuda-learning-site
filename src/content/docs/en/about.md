...
The current 115-entry Practice Bank includes PB-R5-001 through PB-R5-020 and PB-R6-001 through PB-R6-013. R4's eight library-and-algorithm-choice entries and R3's ten Nsight report-analysis entries remain unchanged. Only EX02, EX10 and LAB02 are Compile-Checked; EX10 is Runtime-Not-Applicable. The other 23 examples and all 18 Labs remain Pending Hardware Verification, 41 subjects total. P01-P12, T01-T08 and G01-G09 keep four empty evidence arrays. EX21-EX24 have empty compilation/recorded observations; host checks grant no GPU evidence. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts remain zero. All six profiler plans are expected-only; LAB18's timeline and G07/G09 diagnostic fixtures are synthetic.
