...
As of **2026-09-20**, the current publication has 103 Learning Units, 24 Runnable Examples (EX01-EX24), 18 Labs (LAB01-LAB18), 21 Visual Explainers, 113 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 116 [source records](/en/sources-and-versions/): 475 catalog records, 373 Publication Pairs and 746 source routes, including 102 Exercise sets and 102 separate reviewed-solution sets. [G08](/en/multi-gpu/nccl-graph-capture/) adds collective capture, replay, lifetime and separately gated registration. There are 41 subjects Pending Hardware Verification; G08's external scenarios are also unobserved. R5's frozen review is unchanged and R6 is pending.
...
The current 113-entry Practice Bank includes PB-R5-001 through PB-R5-020 and PB-R6-001 through PB-R6-011. R4's eight library-and-algorithm-choice entries and R3's ten Nsight report-analysis entries remain unchanged. Only EX02, EX10 and LAB02 are Compile-Checked; EX10 is Runtime-Not-Applicable. The other 23 examples and all 18 Labs remain Pending Hardware Verification, 41 subjects total. P01-P12, T01-T08 and G01-G08 keep four empty evidence arrays. EX21-EX24 have empty compilation/recorded observations; host checks grant no GPU evidence. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts remain zero. All six profiler plans are expected-only; LAB18's timeline and G07's diagnostic fixtures are synthetic.
