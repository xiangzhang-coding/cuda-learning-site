...
As of **2026-09-12**, the rolling current publication has 82 Learning Units, 21 Runnable Examples (EX01-EX21), 12 Labs (LAB01-LAB12), 19 formal Visual Explainers (standalone VIS01-VIS14/VIS18 plus embedded VIS19-VIS22), 89 [Practice Bank](/en/practice/) entries, 204 [Glossary](/en/glossary/) terms, and 99 [source records](/en/sources-and-versions/), for 423 catalog records. Public source files form 299 Publication Pairs and 598 source routes, including 81 Exercise sets and 81 separate reviewed-solution sets.
