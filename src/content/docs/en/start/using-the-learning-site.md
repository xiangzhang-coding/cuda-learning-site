...
As of **2026-08-30**, the Stable Curriculum completely publishes 47 Learning Units in both languages: O01-O08, F01-F08, M01-M19, A01-A07, and Q01-Q05. The complete strict prerequisite graph currently published is:

R1 remains the latest completed aggregate release review. The A01-A04, Q02, EX11-EX13, and VIS10 material from [Issue #21](https://github.com/xiangzhang-coding/cuda-learning-site/issues/21) remains current. [Issue #22](https://github.com/xiangzhang-coding/cuda-learning-site/issues/22) now adds A05-A07, EX14, VIS11, and their supporting learning material. This does not complete R2; the aggregate R2 release review remains pending in [issue #24](https://github.com/xiangzhang-coding/cuda-learning-site/issues/24).
...
12. The algorithms track contains [A01: Elementwise Map](/en/algorithms/elementwise-map/), which requires F03, F04, and M02; [A02: Multi-Stage Reduction](/en/algorithms/multi-stage-reduction/) requires M03, M05, and M06; [A03: Inclusive and Exclusive Scan](/en/algorithms/inclusive-exclusive-scan/) requires A02 and M05; [A04: Privatized Histogram](/en/algorithms/privatized-histogram/) requires M03 and M05; [A05: Matrix Transpose](/en/algorithms/matrix-transpose-layout/) requires M02, M03, and M04; [A06: Stencil Neighborhoods and Halos](/en/algorithms/stencil-neighborhood-reuse/) requires M03, M04, and M05; and [A07: Direct 2D Convolution](/en/algorithms/convolution-reuse-layout/) requires A06 and M03.
...
14. Runnable Example edges are `EX03<-F03`, `EX04<-F05`, `EX05<-M02`, `EX06<-[M03,M04]`, `EX07<-[M07,M08,M09]`, `EX08<-M10`, `EX09<-M14`, `EX10<-[M15,M16]`, `EX11<-[A02,Q02]`, `EX12<-A03`, `EX13<-A04`, `EX14<-A05`, and `EX16<-[Q03,Q04]`; EX01 and EX02 have no strict Learning Unit prerequisite. The current set is exactly EX01-EX14 and EX16, while EX15 has no destination. Lab edges are `LAB01<-[O03,O08]`, `LAB02<-[O03,F01]`, `LAB03<-[F03,F05]`, `LAB04<-[M02,Q05]`, `LAB05<-[M04,Q05]`, and `LAB07<-[Q03,Q04]`. LAB06, Q11, and LAB10 are unpublished; LAB10 waits for Q11's evidence-based optimization prerequisite. F08 is related to LAB03 but is not a prerequisite.
...
From that base, the algorithms track continues after A04 by joining M02/M03/M04 at A05, M03/M04/M05 at A06, and A06/M03 at A07. EX14 and VIS11 both strictly require A05. Q11 and LAB10 are unpublished and do not enter the current graph. All existing M, Q, EX, VIS, and Lab edges remain unchanged; these recommendations add no prerequisite edge beyond the graph above.
...
The algorithms route links to Exercises and separate solutions for A01-A07, including [A05 Exercises](/en/algorithms/matrix-transpose-layout/exercises/) and [solutions](/en/algorithms/matrix-transpose-layout/solutions/), [A06 Exercises](/en/algorithms/stencil-neighborhood-reuse/exercises/) and [solutions](/en/algorithms/stencil-neighborhood-reuse/solutions/), and [A07 Exercises](/en/algorithms/convolution-reuse-layout/exercises/) and [solutions](/en/algorithms/convolution-reuse-layout/solutions/). Q02 likewise has [Exercises](/en/correctness/floating-point-order-reproducibility/exercises/) and separate [solutions](/en/correctness/floating-point-order-reproducibility/solutions/).

The [Lab Index](/en/labs/) lists the six complete public Labs LAB01-LAB05/LAB07; LAB06, Q11, and LAB10 do not appear. The [Visual Explainer Index](/en/visuals/) lists fifteen formal explainers: eleven standalone pages VIS01-VIS11 plus embedded VIS19-VIS22; [VIS11](/en/visuals/tiled-transpose/) depends only on A05. Every explainer is a deterministic browser-only model with no CUDA Evidence Status. The current catalog has 6 Labs, 48 [Practice Bank](/en/practice/) entries, 15 Visual Explainers, 146 [Glossary](/en/glossary/) terms, and 59 [Sources and Version Record](/en/sources-and-versions/) entries, for 274 records total. Public content forms 178 Publication Pairs and 356 source routes. You can also open [About](/en/about/) directly.

M09-M19, A01-A07, and Q01-Q05 have empty compilation and runtime axes; static Learning Units, Exercises, and Context7 cross-checks grant no CUDA Evidence Status. EX14 uses one original C++17 implementation across all three Toolkit Lanes, has empty compilation evidence, and remains Pending Hardware Verification. Host-only correctness checks grant no GPU runtime evidence. The site ran no EX14, cuDNN, Compute Sanitizer, or profiler and records no actual output, timing, speedup, or other performance number.
