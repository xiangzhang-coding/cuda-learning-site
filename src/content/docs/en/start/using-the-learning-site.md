...
As of **2026-08-29**, the Stable Curriculum completely publishes 34 Learning Units in both languages: O01-O08, F01-F08, M01-M14, and Q01/Q03-Q05. The complete strict prerequisite graph currently published is:

R1 remains the latest completed aggregate release review. The M09-M14, EX07-EX09, VIS08, and supporting learning material scoped by [Issue #19](https://github.com/xiangzhang-coding/cuda-learning-site/issues/19) are now part of the complete current incremental publication scope. This does not mean that all of R2 is complete; the aggregate R2 release review remains a later release gate.
