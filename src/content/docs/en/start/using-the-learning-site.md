...
As of **2026-09-03**, the current rolling Stable Curriculum publication after [issue #30](https://github.com/xiangzhang-coding/cuda-learning-site/issues/30) completely publishes 60 Learning Units in both languages: O01-O08, F01-F08, M01-M19, A01-A11/A14, and Q01-Q13. The complete strict prerequisite graph currently published is:
...
12. The algorithms track retains A01-A09, adds [A10: Numerically Stable Softmax](/en/algorithms/numerically-stable-softmax/)`<-[A02,M02,M03]` and [A11: Attention as an IO Problem](/en/algorithms/attention-as-an-io-problem/)`<-[A08,A10]`, and retains [A14](/en/algorithms/algorithm-choice-arithmetic-intensity/)`<-[A01,A02,A05,A08]`.
...
14. The Runnable Example set remains EX01-EX16 and the Lab set remains LAB01-LAB10. The visual graph adds [VIS18: Attention Memory Traffic](/en/visuals/attention-memory-traffic/)`<-[A11]`. Later framework, cuDNN, and Triton units remain unpublished.
...
From that base, the algorithms track joins A02/M02/M03 at A10 and A08/A10 at A11; A14 continues to join A01/A02/A05/A08. VIS18 strictly requires A11. Existing correctness and LAB09/LAB10 edges remain unchanged. Unpublished production-library and framework routes stay outside the current graph.
...
The algorithms route links to Exercises and separate solutions for A01-A11 and A14, including [A10 Exercises](/en/algorithms/numerically-stable-softmax/exercises/) and [solutions](/en/algorithms/numerically-stable-softmax/solutions/), plus [A11 Exercises](/en/algorithms/attention-as-an-io-problem/exercises/) and [solutions](/en/algorithms/attention-as-an-io-problem/solutions/).

The [Lab Index](/en/labs/) lists 10 Labs, LAB01-LAB10. The [Visual Explainer Index](/en/visuals/) lists 19 explainers: standalone VIS01-VIS14/VIS18 plus embedded VIS19-VIS22. The current catalog has 10 Labs, 64 [Practice Bank](/en/practice/) entries, 19 Visual Explainers, 170 [Glossary](/en/glossary/) terms, and 74 [source records](/en/sources-and-versions/), for 337 records total. Current rolling public content forms 226 Publication Pairs and 452 source routes. These figures are distinct from immutable R2's 186/372/284 snapshot, and the R3 aggregate review remains pending.

A10 and A11 have all four evidence arrays empty and grant no Evidence Status. Numerical worksheets are host arithmetic; traffic formulas and VIS18 are static analysis. This increment records no GPU numerical output, actual traffic, backend or dtype observation, timing, speedup, winner, Reference Environment, or `performanceObservations`.
...
**Fact-check date: 2026-09-03.** This page is not tied to a CUDA Toolkit version and does not grant CUDA evidence. See the [Glossary](/en/glossary/) for vocabulary and [Sources and Version Record](/en/sources-and-versions/) for publishing and CUDA sources reviewed for this release.
