...
The current 98 Learning Units include [G01](/en/multi-gpu/devices-contexts-ownership/) with prerequisites `[F07,M07]`, [G02](/en/multi-gpu/peer-access-copies/) with `[G01,M01,M08]`, and [G03](/en/multi-gpu/topology-paths/) with `[G01,O03]`. The [Lab Index](/en/labs/) lists 16 Labs and the [Visual Explainer Index](/en/visuals/) lists 20 explainers. There are 105 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 111 [source records](/en/sources-and-versions/): 459 catalog records. SRC-CUDA-094/095/096 record ownership, peer and topology contracts; the ten R3 Nsight report-analysis and eight R4 library-and-algorithm-choice entries remain unchanged.
