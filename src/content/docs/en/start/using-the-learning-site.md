...
The current 100 Learning Units include [G04](/en/multi-gpu/nccl-communicators-collectives/) with prerequisites `[G01,G03]` and [G05](/en/multi-gpu/nccl-stream-dependencies/) with `[G04,M07,M08]`. There are 24 Runnable Examples. The [Lab Index](/en/labs/) lists 17 Labs and the [Visual Explainer Index](/en/visuals/) lists 21 explainers. There are 107 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 113 [source records](/en/sources-and-versions/): 465 catalog records. SRC-CUDA-097/098 record independently pinned NCCL contracts; the ten R3 Nsight report-analysis and eight R4 library-and-algorithm-choice entries remain unchanged.
...
Only EX02, EX10 and LAB02 are Compile-Checked. EX10 is Runtime-Not-Applicable; 23 other examples and 17 Labs remain Pending Hardware Verification, 40 subjects total. P01-P12, T01-T08 and G01-G05 keep empty evidence arrays. EX21-EX24 and LAB13-LAB17 remain Pending Hardware Verification with empty compilation/recorded observations. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts stay zero. Source review and host checks are not GPU evidence.
