...
As of **2026-09-12**, the current Stable Curriculum publication covers 78 Learning Units in both languages: O01-O08, F01-F08, M01-M19, A01-A14, Q01-Q13, L01-L13, and the new P01-P03. The reusable-library path retains [L12: cuFFT Plans, Layouts, and Startup](/en/libraries/cufft-plans-layouts-startup/), [L13: cuSPARSE Descriptors, SpMV, and SpMM](/en/libraries/cusparse-descriptors-spmv-spmm/), and their examples. The Python bridge starts at [P01](/en/python/cuda-python-bridge/) after the existing CUDA lifecycle and stream prerequisites. The complete strict prerequisite graph currently published follows.

R4 remains the latest completed aggregate static review, dated 2026-09-10. Schema 5 `src/r4-release-manifest.json` still supplies the frozen `/release.json`: 75 Learning Units, 277 Publication Pairs, 554 source routes, 74 Exercise sets, 74 separate reviewed-solution sets, and 401 catalog records. R4's historical 82 practice entries, 196 terms, and 92 sources are unchanged. `/publication.json` records the expanded current inventory: 287 Publication Pairs, 574 source routes, 77 Exercise sets, and 77 separate reviewed-solution sets, with R4 latest completed and the next R5 aggregate review pending. R1-R3 remain exact historical snapshots; R3 retains 232 pairs, 464 routes, 347 catalog records, 61 Exercise sets, 61 solution sets, and ten Nsight report-analysis Practice Bank entries.
...
The [Lab Index](/en/labs/) lists 12 Labs, LAB01-LAB12. The [Visual Explainer Index](/en/visuals/) lists 19 explainers: standalone VIS01-VIS14/VIS18 plus embedded VIS19-VIS22. The current catalog has 85 [Practice Bank](/en/practice/) entries, 200 [Glossary](/en/glossary/) terms, and 95 [source records](/en/sources-and-versions/), for 411 catalog records; content forms 287 Publication Pairs and 574 source routes. The Python bridge adds `PB-R5-001/002/003`. The ten R3 Nsight report-analysis entries and eight R4 library-and-algorithm-choice entries remain unchanged: `PB-R4-001`, `PB-R4-002`, `PB-R4-003`, `PB-R4-004`, `PB-R4-008`, `PB-R4-011`, `PB-R4-012`, and `PB-R4-016`.
