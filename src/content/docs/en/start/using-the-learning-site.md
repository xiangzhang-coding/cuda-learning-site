...
14. The reusable-library track adds [L01: Choose a Library, Primitive, DSL, or Custom Kernel](/en/libraries/library-primitive-dsl-custom-kernel/)`<-[A02,A03,A08,Q06]` and [L02: Thrust as an Algorithm Vocabulary](/en/libraries/thrust-algorithm-vocabulary/)`<-[A01,A03,A09]`.
15. The Runnable Example set remains EX01-EX16 and the Lab set remains LAB01-LAB10. The visual graph retains [VIS18: Attention Memory Traffic](/en/visuals/attention-memory-traffic/)`<-[A11]`. L03-L13, LAB11, LAB12, and EX20 remain unpublished.
...
From that base, the algorithms track joins A02/M02/M03 at A10 and A08/A10 at A11; M01/M02 join at A12 and A12/A08 join at A13; A14 continues to join A01/A02/A05/A08. A02/A03/A08/Q06 join at L01, while A01/A03/A09 join at L02. VIS18 strictly requires A11. Existing correctness and LAB09/LAB10 edges remain unchanged. Unpublished L03-L13, LAB11/LAB12, and EX20 stay outside the current graph.
...
The reusable-library route links to [L01 Exercises](/en/libraries/library-primitive-dsl-custom-kernel/exercises/) and [solutions](/en/libraries/library-primitive-dsl-custom-kernel/solutions/), plus [L02 Exercises](/en/libraries/thrust-algorithm-vocabulary/exercises/) and [solutions](/en/libraries/thrust-algorithm-vocabulary/solutions/).

The [Lab Index](/en/labs/) lists 10 Labs, LAB01-LAB10. The [Visual Explainer Index](/en/visuals/) lists 19 explainers: standalone VIS01-VIS14/VIS18 plus embedded VIS19-VIS22. Immutable R3 retains 66 Practice Bank entries, 176 Glossary terms, 76 source records, and 347 catalog records. The rolling current catalog has 68 [Practice Bank](/en/practice/) entries, 182 [Glossary](/en/glossary/) terms, and 78 [source records](/en/sources-and-versions/), for 357 records total; current content forms 238 Publication Pairs and 476 source routes. The R4 aggregate review remains pending.

Q06-Q13, A10-A14, and L01-L02 have all four evidence arrays empty and grant no Evidence Status. L01/L02 display no source and record no local API, build, runtime, synchronization, traffic, fusion, timing, or speed result. The five profiler fixtures are expected-only plans, not captured reports. The current publication declares no Reference Environment or `performanceObservations`.
...
**Fact-check date: 2026-09-04.** This page is not tied to a CUDA Toolkit version and does not grant CUDA evidence. See the [Glossary](/en/glossary/) for vocabulary and [Sources and Version Record](/en/sources-and-versions/) for publishing and CUDA sources reviewed for this release.
