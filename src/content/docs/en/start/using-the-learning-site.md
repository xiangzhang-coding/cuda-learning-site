...
As of **2026-08-31**, the Stable Curriculum completely publishes 49 Learning Units in both languages: O01-O08, F01-F08, M01-M19, A01-A09, and Q01-Q05. The complete strict prerequisite graph currently published is:

R2 is the latest completed aggregate review. [Issue #24](https://github.com/xiangzhang-coding/cuda-learning-site/issues/24) retains the dynamic acceptance record for final CI, Preview, production, and remote smoke. R3 and later material is outside R2.
...
14. The Runnable Example graph adds `EX15<-A08`, and the current set is EX01-EX16. The visual graph adds `VIS12<-A08`. Labs remain LAB01-LAB05/LAB07. Q13, L06, and LAB12 are unpublished; LAB12 waits for both Q13 profiling and L06 cuBLAS prerequisites.
...
From that base, the algorithms track continues from A07 into A08 and joins A03/A04 at A09. EX15 and VIS12 both strictly require A08. Q13, L06, and LAB12 remain outside the current graph.
...
The [Lab Index](/en/labs/) still lists six Labs, with LAB12 unpublished. The [Visual Explainer Index](/en/visuals/) lists 16 explainers: standalone VIS01-VIS12 plus embedded VIS19-VIS22; [VIS12](/en/visuals/gemm-tiling-hierarchy/) depends on A08. The catalog has 6 Labs, 50 [Practice Bank](/en/practice/) entries, 16 Visual Explainers, 151 [Glossary](/en/glossary/) terms, and 61 [source records](/en/sources-and-versions/), for 284 records total. Public content forms 186 Publication Pairs and 372 source routes.

A01-A09 and Q01-Q05 have empty compilation and runtime axes. EX15 uses one original C++17 implementation across three Toolkit Lanes, has empty compilation evidence, and remains Pending Hardware Verification. Host-only checks grant no GPU runtime evidence. The site ran no EX15, CUB, or Thrust and records no output, timing, speedup, or production winner.
