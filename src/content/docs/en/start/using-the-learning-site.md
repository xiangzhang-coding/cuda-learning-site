...
The current 92 Learning Units extend through P12 and T05. [T04](/en/triton/blocked-matrix-multiplication/) requires `[T02,A08,Q10]`; [T05](/en/triton/autotuning/) requires `[T04,Q05,Q06]`. The [Lab Index](/en/labs/) lists 16 Labs and the [Visual Explainer Index](/en/visuals/) lists 20 explainers. There are 100 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 105 [source records](/en/sources-and-versions/): 448 catalog records. PB-R5-017/018 add original GEMM-tail and selection-cache audits; the ten R3 Nsight report-analysis and eight R4 library-and-algorithm-choice entries remain unchanged.
