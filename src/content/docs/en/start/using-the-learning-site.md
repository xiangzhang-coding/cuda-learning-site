...
14. The Runnable Example set remains EX01-EX16 and the Lab set remains LAB01-LAB10. The visual graph retains [VIS18: Attention Memory Traffic](/en/visuals/attention-memory-traffic/)`<-[A11]`. L13/EX20 and later production-library and framework units remain unpublished.
...
From that base, the algorithms track joins A02/M02/M03 at A10 and A08/A10 at A11; M01/M02 join at A12 and A12/A08 join at A13; A14 continues to join A01/A02/A05/A08. VIS18 strictly requires A11. Existing correctness and LAB09/LAB10 edges remain unchanged. Unpublished L13/EX20 and other production-library and framework routes stay outside the current graph.
