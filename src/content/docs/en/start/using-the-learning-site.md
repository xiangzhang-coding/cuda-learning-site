...
As of **2026-09-02**, the current rolling Stable Curriculum publication after [issue #27](https://github.com/xiangzhang-coding/cuda-learning-site/issues/27) completely publishes 56 Learning Units in both languages: O01-O08, F01-F08, M01-M19, A01-A09/A14, and Q01-Q11. The complete strict prerequisite graph currently published is:
...
13. The correctness-and-quality track retains Q01-Q08 and adds [Q09: Interpret Latency Hiding with Occupancy, Stalls, and Throughput](/en/correctness/occupancy-stalls-throughput/)`<-[Q08,F08]`, [Q10: Build an Auditable Roofline from Arithmetic Intensity](/en/correctness/roofline-arithmetic-intensity/)`<-[Q05,A14]`, and [Q11: Optimize the Canonical Transpose with Controlled Evidence](/en/correctness/transpose-optimization-case-study/)`<-[A05,Q06,Q08,Q10]`. Q11 starts from immutable [EX14](/en/examples/tiled-transpose/) and reuses evidence-neutral [VIS11](/en/visuals/tiled-transpose/).
14. The Runnable Example set remains EX01-EX16. The Lab set is LAB01-LAB10, with [LAB09: Build an Original Roofline](/en/labs/build-original-roofline/)`<-[Q10]` and [LAB10: Optimize the Canonical Transpose](/en/labs/optimize-canonical-transpose/)`<-[Q11]`. The visual graph still contains [VIS13: Roofline](/en/visuals/roofline/)`<-[Q10]`. Q13, L06, and LAB12 remain unpublished; LAB12 waits for Q13 and L06.
...
From that base, the algorithms track adds A14 after A09 by joining A01/A02/A05/A08. The correctness route adds Q09 after Q08 by joining Q08/F08, joins Q05/A14 at Q10, and then joins A05/Q06/Q08/Q10 at Q11. LAB09 and VIS13 strictly require Q10; LAB10 strictly requires Q11. Q13, L06, and LAB12 remain outside the current graph, and LAB12 waits for Q13 and L06.
...
**Fact-check date: 2026-09-02.** This page is not tied to a CUDA Toolkit version and does not grant CUDA evidence. See the [Glossary](/en/glossary/) for vocabulary and [Sources and Version Record](/en/sources-and-versions/) for publishing and CUDA sources reviewed for this release.
