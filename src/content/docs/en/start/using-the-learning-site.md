...
16. The 23 Runnable Examples are EX01-EX23; [EX21](/en/examples/cuda-python-launch/) retains `[P02]`, [EX20](/en/examples/cusparse-spmv/) retains `[L13]`, [EX19](/en/examples/cufft-batched-transform/) retains `[L12]`, and [EX18](/en/examples/cublas-gemm/) retains `[L06]`. The 15 Labs are LAB01-LAB15; [LAB12](/en/labs/compare-gemm-with-cublas/) retains `[Q13,L06]`. [EX22](/en/examples/adjacent-energy/) and [LAB13](/en/labs/build-custom-operator/) both require `[P08,P09]`. [LAB14](/en/labs/profile-custom-operator/) requires `[P11]`; [LAB15](/en/labs/verify-fused-softmax/) requires `[T02,A10,Q05]`. [VIS18](/en/visuals/attention-memory-traffic/) still requires `[A11]`. [EX23](/en/examples/triton-vector-add/) requires `[T02]`, and [VIS17](/en/visuals/simt-triton-mapping/) requires `[T01]`.
...
The current 90 Learning Units extend through P12 and T03. [T01](/en/triton/programs-and-block-values/) requires `[F02,F03,M02]`; [T02](/en/triton/masked-vector-addition/) requires `[T01,A01]`; [T03](/en/triton/fused-softmax/) requires `[T02,A10,Q05]`. The [Lab Index](/en/labs/) lists 15 Labs and the [Visual Explainer Index](/en/visuals/) lists 20 explainers. There are 98 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 104 [source records](/en/sources-and-versions/): 444 catalog records. PB-R5-015/016 add original softmax padding/timing audits; the ten R3 Nsight report-analysis and eight R4 library-and-algorithm-choice entries remain unchanged.
...
Only EX02, EX10 and LAB02 are Compile-Checked. EX10 is Runtime-Not-Applicable; 22 other examples and 15 Labs remain Pending Hardware Verification, 37 subjects total. P01-P12 and T01-T03 keep empty evidence arrays. EX21-EX23 and LAB13/LAB14/LAB15 remain Pending Hardware Verification with empty compilation/recorded observations. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts stay zero. Source review and host checks are not GPU evidence.
