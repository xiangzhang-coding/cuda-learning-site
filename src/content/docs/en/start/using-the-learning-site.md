...
16. The 22 Runnable Examples are EX01-EX22; [EX21](/en/examples/cuda-python-launch/) retains `[P02]`, [EX20](/en/examples/cusparse-spmv/) retains `[L13]`, [EX19](/en/examples/cufft-batched-transform/) retains `[L12]`, and [EX18](/en/examples/cublas-gemm/) retains `[L06]`. The 14 Labs are LAB01-LAB14; [LAB12](/en/labs/compare-gemm-with-cublas/) retains `[Q13,L06]`. [EX22](/en/examples/adjacent-energy/) and [LAB13](/en/labs/build-custom-operator/) both require `[P08,P09]`. [LAB14](/en/labs/profile-custom-operator/) requires `[P11]`. [VIS18](/en/visuals/attention-memory-traffic/) still requires `[A11]`.
...
The current 87 Learning Units extend through P12. [P11](/en/frameworks/profile-led-optimization/) requires `[P07,P09,Q06]`; [P12](/en/frameworks/sdpa-dispatch-verification/) requires `[A11,L11,P06,P07]`. The [Lab Index](/en/labs/) lists 14 Labs and the [Visual Explainer Index](/en/visuals/) lists 19 explainers. There are 94 [Practice Bank](/en/practice/) entries, 204 [Glossary](/en/glossary/) terms and 102 [source records](/en/sources-and-versions/): 433 catalog records. PB-R5-011/012 add original optimization/dispatch audits; the ten R3 Nsight report-analysis and eight R4 library-and-algorithm-choice entries remain unchanged.

P04-P07 keep empty evidence arrays and the [independent eager environment](/en/sources-and-versions/#src-cuda-080): torch 2.11.0+cu128, CPython 3.12.14, packaged CUDA 12.8.1/runtime 12.8.90 and the native allocator. Eager work needs no system Toolkit. [P08](/en/frameworks/first-custom-operator/) requires `[O04,F04,Q01,P04]`, [P09](/en/frameworks/operator-registration/) requires `[P08,Q01]`, and [P10](/en/frameworks/operator-packaging/) requires `[P08,M18]`; each includes Exercises and separate solutions. Their extension project separately requires Toolkit 12.8.1/NVCC 12.8.93/GCC 13.3.0. Triton destinations remain unpublished.

Only EX02, EX10 and LAB02 are Compile-Checked. EX10 is Runtime-Not-Applicable; 21 other examples and 14 Labs remain Pending Hardware Verification, 35 subjects total. P01-P12 keep empty evidence arrays. EX21/EX22 and LAB13/LAB14 remain Pending Hardware Verification with empty compilation/recorded observations. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts stay zero. Source review and host checks are not GPU evidence.
