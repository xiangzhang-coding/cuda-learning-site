...
15. The Runnable Example set is EX01-EX18, ending with [EX18: cuBLAS GEMM](/en/examples/cublas-gemm/)`<-[L06]`. The Lab set is LAB01-LAB12, ending with [LAB12: Compare an Educational GEMM with cuBLAS](/en/labs/compare-gemm-with-cublas/)`<-[Q13,L06]`. The visual graph retains [VIS18: Attention Memory Traffic](/en/visuals/attention-memory-traffic/)`<-[A11]`. L08-L13 and EX20 remain pending.
