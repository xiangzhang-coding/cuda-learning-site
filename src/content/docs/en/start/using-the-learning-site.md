...
As of **2026-09-05**, the R3 Stable Curriculum reviewed in [issue #32](https://github.com/xiangzhang-coding/cuda-learning-site/issues/32) completely publishes 62 Learning Units in both languages: O01-O08, F01-F08, M01-M19, A01-A14, and Q01-Q13. The rolling current surface adds L01-L02 through issue #33, then publishes [L03](/en/libraries/cub-device-primitives/), [L04](/en/libraries/cub-warp-block-primitives/), [EX17](/en/examples/cub-device-reduction-scan/), and [LAB11](/en/labs/compare-custom-reduction-with-cub/) through [issue #34](https://github.com/xiangzhang-coding/cuda-learning-site/issues/34), for 66 Learning Units. The complete strict prerequisite graph currently published is:

The completed R3 aggregate release review is an immutable snapshot fixed at 232 Publication Pairs, 464 source routes, and 347 catalog records. It also inventories 61 Exercise sets, 61 separate reviewed-solution sets, and 10 Nsight report-analysis Practice Bank entries. The rolling current surface has 246 Publication Pairs, 492 source routes, 65 Exercise sets, 65 separate reviewed-solution sets, and 364 catalog records. R1 and R2 remain historical coordinates, and the R4 aggregate review remains pending.
...
14. The reusable-library track contains [L01: Choose a Library, Primitive, DSL, or Custom Kernel](/en/libraries/library-primitive-dsl-custom-kernel/)`<-[A02,A03,A08,Q06]`, [L02: Thrust as an Algorithm Vocabulary](/en/libraries/thrust-algorithm-vocabulary/)`<-[A01,A03,A09]`, [L03: Use CUB Device Primitives for Reduction and Scan](/en/libraries/cub-device-primitives/)`<-[A02,A03,M07,L01]`, and [L04: Compose Kernels with CUB Warp and Block Primitives](/en/libraries/cub-warp-block-primitives/)`<-[F02,M03,M05,A02,A03,L03]`.
15. The Runnable Example set is EX01-EX17, ending with [EX17: CUB Device Reduction and Scan](/en/examples/cub-device-reduction-scan/). The Lab set is LAB01-LAB11, ending with [LAB11: Compare a Custom Reduction with CUB](/en/labs/compare-custom-reduction-with-cub/)`<-[Q12,L03]`. The visual graph retains [VIS18: Attention Memory Traffic](/en/visuals/attention-memory-traffic/)`<-[A11]`. L05-L13, LAB12, and EX20 remain pending.
...
From that base, the algorithms track joins A02/M02/M03 at A10 and A08/A10 at A11; M01/M02 join at A12 and A12/A08 join at A13; A14 continues to join A01/A02/A05/A08. A02/A03/A08/Q06 join at L01, A01/A03/A09 join at L02, A02/A03/M07/L01 join at L03, and F02/M03/M05/A02/A03/L03 join at L04. Q12/L03 join at LAB11, with EX17 supplying its canonical CUB path. VIS18 strictly requires A11. L05-L13, LAB12, and EX20 stay outside the current graph.
...
The reusable-library route links to [L01 Exercises](/en/libraries/library-primitive-dsl-custom-kernel/exercises/) and [solutions](/en/libraries/library-primitive-dsl-custom-kernel/solutions/), [L02 Exercises](/en/libraries/thrust-algorithm-vocabulary/exercises/) and [solutions](/en/libraries/thrust-algorithm-vocabulary/solutions/), [L03 Exercises](/en/libraries/cub-device-primitives/exercises/) and [solutions](/en/libraries/cub-device-primitives/solutions/), plus [L04 Exercises](/en/libraries/cub-warp-block-primitives/exercises/) and [solutions](/en/libraries/cub-warp-block-primitives/solutions/).

The [Lab Index](/en/labs/) lists 11 Labs, LAB01-LAB11. The [Visual Explainer Index](/en/visuals/) lists 19 explainers: standalone VIS01-VIS14/VIS18 plus embedded VIS19-VIS22. Immutable R3 retains 66 Practice Bank entries, 176 Glossary terms, 76 source records, and 347 catalog records. The rolling current catalog has 70 [Practice Bank](/en/practice/) entries, 184 [Glossary](/en/glossary/) terms, and 80 [source records](/en/sources-and-versions/), for 364 records total; current content forms 246 Publication Pairs and 492 source routes. The R4 aggregate review remains pending.

Q06-Q13, A10-A14, and L01-L04 have all four evidence arrays empty and grant no Evidence Status. EX17 and LAB11 have empty compilation evidence and recorded observations, no observed runtime evidence, and remain Pending Hardware Verification. EX17's five component-matrix rows are a non-evidentiary build gate and do not state that CI ran. All six current profiler fixtures are expected-only plans, not captured reports. The current publication declares no Reference Environment or `performanceObservations`.
