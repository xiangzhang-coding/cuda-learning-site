...
As of **2026-09-02**, the current rolling Stable Curriculum publication after [issue #28](https://github.com/xiangzhang-coding/cuda-learning-site/issues/28) completely publishes 57 Learning Units in both languages: O01-O08, F01-F08, M01-M19, A01-A09/A14, and Q01-Q12. The complete strict prerequisite graph currently published is:
...
From that base, the algorithms track adds A14 after A09 by joining A01/A02/A05/A08. The correctness route adds Q09 after Q08 by joining Q08/F08, joins Q05/A14 at Q10, joins A05/Q06/Q08/Q10 at Q11, and joins A02/Q02/Q06/Q08 at Q12. LAB09 and VIS13 strictly require Q10; LAB10 strictly requires Q11. L03/LAB11 and Q13/L06/LAB12 remain outside the current graph.
...
The [Lab Index](/en/labs/) lists 10 Labs, LAB01-LAB10. The [Visual Explainer Index](/en/visuals/) still lists 18 explainers: standalone VIS01-VIS14 plus embedded VIS19-VIS22. The current catalog has 10 Labs, 60 [Practice Bank](/en/practice/) entries, 18 Visual Explainers, 165 [Glossary](/en/glossary/) terms, and 71 [source records](/en/sources-and-versions/), for 324 records total. Current rolling public content forms 216 Publication Pairs and 432 source routes. These figures are distinct from immutable R2's 186/372/284 snapshot, and the R3 aggregate review remains pending.

Q11 and Q12 are Learning Units with all four evidence arrays empty and grant no Evidence Status. Linked EX11, EX14, and LAB10 retain empty compilation and recorded observations and Pending Hardware Verification runtime. Immutable source, VIS10 and VIS11, static runner gates, and expected-only fixtures change no boundary. This increment records no numerical output, timing, metric, speedup, bottleneck, winner, Reference Environment, or `performanceObservations`.
