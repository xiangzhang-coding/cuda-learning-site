...
16. The 22 Runnable Examples are EX01-EX22; [EX21](/en/examples/cuda-python-launch/) retains `[P02]`, [EX20](/en/examples/cusparse-spmv/) retains `[L13]`, [EX19](/en/examples/cufft-batched-transform/) retains `[L12]`, and [EX18](/en/examples/cublas-gemm/) retains `[L06]`. The 13 Labs are LAB01-LAB13; [LAB12](/en/labs/compare-gemm-with-cublas/) retains `[Q13,L06]`. [EX22](/en/examples/adjacent-energy/) and [LAB13](/en/labs/build-custom-operator/) both require `[P08,P09]`. [VIS18](/en/visuals/attention-memory-traffic/) still requires `[A11]`.
...
The current 85 Learning Units extend through P10. The [Lab Index](/en/labs/) lists 13 Labs and the [Visual Explainer Index](/en/visuals/) lists 19 explainers. There are 92 [Practice Bank](/en/practice/) entries, 204 [Glossary](/en/glossary/) terms and 101 [source records](/en/sources-and-versions/): 429 catalog records. PB-R5-008/009/010 add original operator audits; the ten R3 Nsight report-analysis and eight R4 library-and-algorithm-choice entries remain unchanged.
...
Only EX02, EX10 and LAB02 are Compile-Checked. EX10 is Runtime-Not-Applicable; 21 other examples and 13 Labs remain Pending Hardware Verification, 34 subjects total. P01-P10 keep empty evidence arrays. EX21/EX22 and LAB13 remain Pending Hardware Verification with empty compilation/recorded observations. Runtime-Verified, Community-Observed, Reference Environment and performance-observation counts stay zero. Source review and host checks are not GPU evidence.
