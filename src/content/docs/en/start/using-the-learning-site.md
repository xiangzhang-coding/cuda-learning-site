...
The current 101 Learning Units include [G06](/en/multi-gpu/communication-computation-overlap/) with prerequisites `[G05,Q05,Q07]`. There are 24 Runnable Examples. The [Lab Index](/en/labs/) lists 18 Labs and the [Visual Explainer Index](/en/visuals/) lists 21 explainers. There are 109 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 114 [source records](/en/sources-and-versions/): 469 catalog records. SRC-CUDA-099 records independently reviewed NCCL/profiler contracts; the ten R3 Nsight report-analysis and eight R4 library-and-algorithm-choice entries remain unchanged. There are 41 subjects Pending Hardware Verification.
