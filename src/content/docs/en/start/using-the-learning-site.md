...
The current 103 Learning Units include [G07](/en/multi-gpu/pytorch-ddp-nccl/) with prerequisites `[P04,P05,G04]` and [G08](/en/multi-gpu/nccl-graph-capture/) with `[G05,M14]`. There are 24 Runnable Examples. The [Lab Index](/en/labs/) lists 18 Labs and the [Visual Explainer Index](/en/visuals/) lists 21 explainers. There are 113 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 116 [source records](/en/sources-and-versions/): 475 catalog records. SRC-CUDA-101 records exact capture/registration contracts; the ten R3 Nsight report-analysis and eight R4 library-and-algorithm-choice entries remain unchanged. There are 41 subjects Pending Hardware Verification. G08's four evidence arrays are empty and its external scenarios are unobserved.
