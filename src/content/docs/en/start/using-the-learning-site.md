...
The current 94 Learning Units extend through P12 and T07. [T06](/en/triton/debugging/) requires `[T02,Q03,Q04]`; [T07](/en/triton/persistent-kernels/) requires `[T04,T05,Q09]`. The [Lab Index](/en/labs/) lists 16 Labs and the [Visual Explainer Index](/en/visuals/) lists 20 explainers. There are 102 [Practice Bank](/en/practice/) entries, 207 [Glossary](/en/glossary/) terms and 107 [source records](/en/sources-and-versions/): 452 catalog records. PB-R5-019/020 add original diagnostic and persistent-ownership audits; the ten R3 Nsight report-analysis and eight R4 library-and-algorithm-choice entries remain unchanged.
