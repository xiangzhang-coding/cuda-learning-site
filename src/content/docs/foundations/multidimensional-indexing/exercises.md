...
先提交每题要求的可复核产物，再依次打开提示。实现复核从[固定提交中的 EX03 canonical project](https://github.com/xiangzhang-coding/cuda-learning-site/tree/b5d0dab070946eedc41e2bfe0106b67d8c01706b/examples/ex03-multidimensional-indexing)开始，不从学习页面拼接第二份程序。完成后使用独立的[参考解答](/foundations/multidimensional-indexing/solutions/)复核推理。
