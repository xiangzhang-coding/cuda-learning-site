    ...
    generations: [
      {
        ...
        recordMarker: {
          ...
          kind: 'record',
          sequence: 1,
          afterOperationId: 'generation-producer-P1',
        },
        waitEdge: {
          id: 'wait-E1',
          sequence: 2,
          fromRecordMarkerId: 'record-E1',
          waitBeforeOperationId: 'generation-consumer-C1',
      ...
      },
      {
        ...
        recordMarker: {
          ...
          kind: 're-record',
          sequence: 3,
          afterOperationId: 'generation-producer-P2',
        },
        waitEdge: {
          id: 'wait-E2',
          sequence: 4,
          fromRecordMarkerId: 'record-E2',
          waitBeforeOperationId: 'generation-consumer-C2',
