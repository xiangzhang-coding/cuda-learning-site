...
Original instructional prose in `src/content/docs/` and original visual teaching compositions are licensed under the [Creative Commons Attribution 4.0 International Public License](LICENSE-CONTENT). This includes O04-O08 and their Exercises and solutions; F01-F08 and M01-M04 and their Exercises and solutions; the EX01-EX06 and LAB01-LAB03 publication pages; all 21 Practice Bank entries; all 76 Glossary terms and 34 source/version records; the four OrientationVisual compositions; the Compatibility Explorer composition; F04's static lifecycle table; and all nine formal Visual Explainers: standalone VIS01, VIS02, VIS04, VIS05, and VIS06 plus embedded VIS19-VIS22. Every Markdown or MDX file declares `license: CC-BY-4.0` and `provenance: original` in frontmatter.
...
All prose, code, teaching tables, and tests added for the published curriculum are original. The M01-M04 memory track, their Exercises and separate solutions, EX05/EX06 publication pages and canonical projects, four new Practice Bank entries, eleven new Glossary terms, three new source records, and VIS04-VIS06 work are original as well. VIS01, VIS02, VIS04, VIS05, VIS06, and embedded VIS19-VIS22 are the nine formal Visual Explainers. VIS04-VIS06 use standalone pages; VIS19-VIS22 keep static or textual fallbacks inside their Learning Units instead of adding four duplicate standalone pages. Every formal Visual Explainer is deterministic, browser-only, and grants no CUDA Evidence Status. The OrientationVisual views, Compatibility Explorer, and F04 static lifecycle table likewise use original teaching compositions without creating evidence. Component and pure-model implementations under `src/components/` and `src/visuals/`, example software, styles, and tests are original software under Apache-2.0; instructional prose and rendered teaching compositions are original work covered by the page-level CC BY 4.0 declaration. Package-provided interface assets remain under their upstream terms and are recorded in `THIRD_PARTY_NOTICES.md`.
