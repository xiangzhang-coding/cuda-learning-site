...
Original instructional prose in `src/content/docs/` and original visual teaching compositions are licensed under the [Creative Commons Attribution 4.0 International Public License](LICENSE-CONTENT). This includes O04-O08 and their Exercises and solutions; F01-F08 and their Exercises and solutions; the EX01-EX04 and LAB01-LAB03 publication pages; all seventeen Practice Bank entries; the expanded Glossary and source/version records; the four OrientationVisual compositions; the Compatibility Explorer composition; F04's static lifecycle table; and the embedded error timeline, capability filter, API boundary, and block-shape explorer teaching compositions. Every Markdown or MDX file declares `license: CC-BY-4.0` and `provenance: original` in frontmatter.
