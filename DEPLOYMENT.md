...
The rolling `src/current-publication-manifest.json` and its `/publication.json` output include L01-L07, EX17/EX18, and LAB11/LAB12: 69 Learning Units, 18 Runnable Examples, 12 Labs, 19 Visual Explainers, 74 Practice Bank entries, 188 Glossary terms, 84 source records, 377 catalog records, 68 Exercise-set and 68 solution-set Publication Pairs, 257 Publication Pairs, and 514 source routes. L06/L07/EX18/LAB12 are complete publication subjects; L08-L13 and the R4 aggregate review remain pending. This publication-scope update is dated 2026-09-06, not a new infrastructure review, deployment, or acceptance claim. Issue #32 retains dynamic R3 acceptance.
