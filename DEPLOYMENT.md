...
The rolling `src/current-publication-manifest.json` and its `/publication.json` output include L01-L09, EX17/EX18, and LAB11/LAB12: 71 Learning Units, 18 Runnable Examples, 12 Labs, 19 Visual Explainers, 76 Practice Bank entries, 190 Glossary terms, 86 source records, 383 catalog records, 70 Exercise-set and 70 solution-set Publication Pairs, 263 Publication Pairs, and 526 source routes. Issue #37 adds complete L08/L09 Publication Pairs and their new Exercises and separate reviewed solutions; L10-L13 and the R4 aggregate review remain pending. This publication-inventory-only update is dated 2026-09-07, not a new API or infrastructure review, deployment, or acceptance claim; existing source-item dates remain unchanged. Issue #32 retains dynamic R3 acceptance.
