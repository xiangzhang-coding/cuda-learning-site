...
The license members in the downloaded core, bindings, and pathfinder wheels match the owner-file hashes above. EX21's `requirements.lock` pins four Linux/GIL wheels; source/license/hash inspection does not establish installation, native compilation or runtime correctness. Native NVRTC/nvJitLink 13.3.33 and driver target 610.43.02 belong to the separately installed Toolkit 13.3.1 profile and retain NVIDIA's SDK/documentation terms. No upstream adaptation requires a new project `NOTICE` entry. P01-P03 have empty evidence arrays; EX21 has no retained compilation or recorded runtime observations and remains Pending Hardware Verification.
